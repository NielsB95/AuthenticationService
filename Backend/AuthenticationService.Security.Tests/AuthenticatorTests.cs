...
namespace AuthenticationService.Security.Tests
{
	...
	public class AuthenticatorTests
	{
		...
		public void Initialize()
		{
			...
			context.Add(new User() { Username = "john", Lastname = "Joe", Password = "+Y0VT7pj7C7vvMUsmBBaaGHoCvrSrO6hUWglzbec7Ag=", CreatedAt = new DateTime(2018, 12, 22) });
			context.Add(new User() { Username = "Jane", Lastname = "", Password = "pass", CreatedAt = new DateTime(2018, 12, 23) });
			context.SaveChanges();
